...
public class BlockMKasa_brown extends Block {
	...
	public BlockMKasa_brown(Material material) {
		super(material);
		this.setUnlocalizedName("mkasa_brown");
		this.setRegistryName("BlockMKasa_brown");
