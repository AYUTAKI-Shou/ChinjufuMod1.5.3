...
public class BlockMKasa_lightb extends Block {
	...
	public BlockMKasa_lightb(Material material) {
		super(material);
		this.setUnlocalizedName("mkasa_lightb");
		this.setRegistryName("BlockMKasa_lightb");
