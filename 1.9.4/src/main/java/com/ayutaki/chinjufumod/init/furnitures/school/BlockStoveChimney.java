...
public class BlockStoveChimney extends Block {
    ...
    public BlockStoveChimney(Material material) {
        super(material);
        this.setRegistryName("BlockStoveChimney");
        this.setUnlocalizedName("stovechimney");
    ...
    public boolean canConnectTo(IBlockAccess worldIn, BlockPos pos) {
        return worldIn.getBlockState(pos).getBlock() instanceof BlockStoveChimney;
    }
