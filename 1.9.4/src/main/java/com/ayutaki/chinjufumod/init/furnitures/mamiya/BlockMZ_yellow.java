...
public class BlockMZ_yellow extends Block {

	private static final AxisAlignedBB BOUNDING_BOX = new AxisAlignedBB(0.0625, 0.0, 0.0625, 0.9375, 0.0625, 0.9375);

	public BlockMZ_yellow(Material material) {
		super(Material.CLOTH);
		this.setUnlocalizedName("mzabuton_yellow");
		this.setRegistryName("BlockMZ_yellow");
