...
public class BlockCafeTable_j extends Block {
	...
	public BlockCafeTable_j(Material material) {
		super(material);
		this.setUnlocalizedName("cafetable_j");
		this.setRegistryName("BlockCafeTable_j");
