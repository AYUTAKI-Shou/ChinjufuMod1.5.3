...
public class BlockCafeTable_s extends Block {
	...
	public BlockCafeTable_s(Material material) {
		super(material);
		this.setUnlocalizedName("cafetable_s");
		this.setRegistryName("BlockCafeTable_s");
