...
public class BlockZaisu_lightg extends Block {
	...
	public BlockZaisu_lightg(Material material) {
		super(material);
		this.setUnlocalizedName("zaisu_lightg");
		this.setRegistryName("BlockZaisu_lightg");
