...
public class BlockZaisu_white extends Block {
	...
	public BlockZaisu_white(Material material) {
		super(material);
		this.setUnlocalizedName("zaisu_white");
		this.setRegistryName("BlockZaisu_white");
