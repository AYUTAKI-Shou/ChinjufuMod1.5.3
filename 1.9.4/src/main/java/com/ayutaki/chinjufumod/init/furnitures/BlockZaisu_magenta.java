...
public class BlockZaisu_magenta extends Block {
	...
	public BlockZaisu_magenta(Material material) {
		super(material);
		this.setUnlocalizedName("zaisu_magenta");
		this.setRegistryName("BlockZaisu_magenta");
