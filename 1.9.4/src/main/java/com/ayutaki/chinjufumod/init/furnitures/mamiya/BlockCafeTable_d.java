...
public class BlockCafeTable_d extends Block {
	...
	public BlockCafeTable_d(Material material) {
		super(material);
		this.setUnlocalizedName("cafetable_d");
		this.setRegistryName("BlockCafeTable_d");
