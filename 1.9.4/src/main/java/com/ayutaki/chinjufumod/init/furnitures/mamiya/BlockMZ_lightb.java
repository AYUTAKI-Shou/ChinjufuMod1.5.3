...
public class BlockMZ_lightb extends Block {

	private static final AxisAlignedBB BOUNDING_BOX = new AxisAlignedBB(0.0625, 0.0, 0.0625, 0.9375, 0.0625, 0.9375);

	public BlockMZ_lightb(Material material) {
		super(Material.CLOTH);
		this.setUnlocalizedName("mzabuton_lightb");
		this.setRegistryName("BlockMZ_lightb");
