...
public class BlockZaisu_black extends Block {
	...
	public BlockZaisu_black(Material material) {
		super(material);
		this.setUnlocalizedName("zaisu_black");
		this.setRegistryName("BlockZaisu_black");
