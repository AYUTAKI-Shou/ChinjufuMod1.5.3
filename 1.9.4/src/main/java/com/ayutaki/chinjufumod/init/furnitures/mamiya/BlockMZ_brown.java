...
public class BlockMZ_brown extends Block {

	private static final AxisAlignedBB BOUNDING_BOX = new AxisAlignedBB(0.0625, 0.0, 0.0625, 0.9375, 0.0625, 0.9375);

	public BlockMZ_brown(Material material) {
		super(Material.CLOTH);
		this.setUnlocalizedName("mzabuton_brown");
		this.setRegistryName("BlockMZ_brown");
