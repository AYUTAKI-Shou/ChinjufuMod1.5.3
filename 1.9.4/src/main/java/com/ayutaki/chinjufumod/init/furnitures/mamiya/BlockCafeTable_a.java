...
public class BlockCafeTable_a extends Block {
	...
	public BlockCafeTable_a(Material material) {
		super(material);
		this.setUnlocalizedName("cafetable_a");
		this.setRegistryName("BlockCafeTable_a");
