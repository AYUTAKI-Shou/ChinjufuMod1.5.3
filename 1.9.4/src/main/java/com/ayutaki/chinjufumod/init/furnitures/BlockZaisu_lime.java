...
public class BlockZaisu_lime extends Block {
	...
	public BlockZaisu_lime(Material material) {
		super(material);
		this.setUnlocalizedName("zaisu_lime");
		this.setRegistryName("BlockZaisu_lime");
