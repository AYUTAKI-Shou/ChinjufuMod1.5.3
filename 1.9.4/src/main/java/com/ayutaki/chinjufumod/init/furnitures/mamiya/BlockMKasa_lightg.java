...
public class BlockMKasa_lightg extends Block {
	...
	public BlockMKasa_lightg(Material material) {
		super(material);
		this.setUnlocalizedName("mkasa_lightg");
		this.setRegistryName("BlockMKasa_lightg");
