...
public class BlockMZ_white extends Block {

	private static final AxisAlignedBB BOUNDING_BOX = new AxisAlignedBB(0.0625, 0.0, 0.0625, 0.9375, 0.0625, 0.9375);

	public BlockMZ_white(Material material) {
		super(Material.CLOTH);
		this.setUnlocalizedName("mzabuton_white");
		this.setRegistryName("BlockMZ_white");
