...
public class BlockZaisu_brown extends Block {
	...
	public BlockZaisu_brown(Material material) {
		super(material);
		this.setUnlocalizedName("zaisu_brown");
		this.setRegistryName("BlockZaisu_brown");
