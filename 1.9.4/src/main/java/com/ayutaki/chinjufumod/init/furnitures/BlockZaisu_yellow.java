...
public class BlockZaisu_yellow extends Block {
	...
	public BlockZaisu_yellow(Material material) {
		super(material);
		this.setUnlocalizedName("zaisu_yellow");
		this.setRegistryName("BlockZaisu_yellow");
