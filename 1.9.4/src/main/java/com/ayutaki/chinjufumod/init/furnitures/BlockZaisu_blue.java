...
public class BlockZaisu_blue extends Block {
	...
	public BlockZaisu_blue(Material material) {
		super(material);
		this.setUnlocalizedName("zaisu_blue");
		this.setRegistryName("BlockZaisu_blue");
