...
public class BlockMKasa_gray extends Block {
	...
	public BlockMKasa_gray(Material material) {
		super(material);
		this.setUnlocalizedName("mkasa_gray");
		this.setRegistryName("BlockMKasa_gray");
