...
public class BlockMKasa_purple extends Block {
	...
	public BlockMKasa_purple(Material material) {
		super(material);
		this.setUnlocalizedName("mkasa_purple");
		this.setRegistryName("BlockMKasa_purple");
