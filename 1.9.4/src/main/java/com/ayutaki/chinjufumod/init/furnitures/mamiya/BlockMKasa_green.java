...
public class BlockMKasa_green extends Block {
	...
	public BlockMKasa_green(Material material) {
		super(material);
		this.setUnlocalizedName("mkasa_green");
		this.setRegistryName("BlockMKasa_green");
