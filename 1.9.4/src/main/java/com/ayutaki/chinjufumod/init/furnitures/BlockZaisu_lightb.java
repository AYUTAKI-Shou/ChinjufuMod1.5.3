...
public class BlockZaisu_lightb extends Block {
	...
	public BlockZaisu_lightb(Material material) {
		super(material);
		this.setUnlocalizedName("zaisu_lightb");
		this.setRegistryName("BlockZaisu_lightb");
