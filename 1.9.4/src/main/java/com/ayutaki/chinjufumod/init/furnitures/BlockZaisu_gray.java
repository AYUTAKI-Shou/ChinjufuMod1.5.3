...
public class BlockZaisu_gray extends Block {
	...
	public BlockZaisu_gray(Material material) {
		super(material);
		this.setUnlocalizedName("zaisu_gray");
		this.setRegistryName("BlockZaisu_gray");
