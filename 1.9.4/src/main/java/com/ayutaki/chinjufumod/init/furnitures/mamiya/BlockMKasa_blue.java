...
public class BlockMKasa_blue extends Block {
	...
	public BlockMKasa_blue(Material material) {
		super(material);
		this.setUnlocalizedName("mkasa_blue");
		this.setRegistryName("BlockMKasa_blue");
