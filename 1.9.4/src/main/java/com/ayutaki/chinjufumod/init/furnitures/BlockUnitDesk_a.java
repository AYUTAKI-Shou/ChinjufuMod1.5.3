...
public class BlockUnitDesk_a extends Block {
	...
	public BlockUnitDesk_a(Material material) {
		super(material);
		this.setUnlocalizedName("unitdesk_a");
		this.setRegistryName("BlockUnitDesk_a");
