...
public class BlockUnitDesk_j extends Block {
	...
	public BlockUnitDesk_j(Material material) {
		super(material);
		this.setUnlocalizedName("unitdesk_j");
		this.setRegistryName("BlockUnitDesk_j");
