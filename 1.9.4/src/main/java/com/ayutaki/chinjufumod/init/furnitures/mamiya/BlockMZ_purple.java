...
public class BlockMZ_purple extends Block {

	private static final AxisAlignedBB BOUNDING_BOX = new AxisAlignedBB(0.0625, 0.0, 0.0625, 0.9375, 0.0625, 0.9375);

	public BlockMZ_purple(Material material) {
		super(Material.CLOTH);
		this.setUnlocalizedName("mzabuton_purple");
		this.setRegistryName("BlockMZ_purple");
