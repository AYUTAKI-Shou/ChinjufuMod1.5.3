...
public class BlockSchoolChair_s extends Block {
	...
	public BlockSchoolChair_s(Material material) {
		super(material);
		this.setUnlocalizedName("schoolchair_s");
		this.setRegistryName("BlockSchoolChair_s");
