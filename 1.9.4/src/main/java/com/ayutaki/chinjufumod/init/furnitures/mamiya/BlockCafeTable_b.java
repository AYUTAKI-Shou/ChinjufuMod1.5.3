...
public class BlockCafeTable_b extends Block {
	...
	public BlockCafeTable_b(Material material) {
		super(material);
		this.setUnlocalizedName("cafetable_b");
		this.setRegistryName("BlockCafeTable_b");
