...
public class BlockZaisu_pink extends Block {
	...
	public BlockZaisu_pink(Material material) {
		super(material);
		this.setUnlocalizedName("zaisu_pink");
		this.setRegistryName("BlockZaisu_pink");
