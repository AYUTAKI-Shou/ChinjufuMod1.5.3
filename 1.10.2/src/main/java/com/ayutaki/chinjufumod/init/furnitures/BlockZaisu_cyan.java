...
public class BlockZaisu_cyan extends Block {
	...
	public BlockZaisu_cyan(Material material) {
		super(material);
		this.setUnlocalizedName("zaisu_cyan");
		this.setRegistryName("BlockZaisu_cyan");
