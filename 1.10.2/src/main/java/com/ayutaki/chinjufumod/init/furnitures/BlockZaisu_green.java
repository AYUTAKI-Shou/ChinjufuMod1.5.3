...
public class BlockZaisu_green extends Block {
	...
	public BlockZaisu_green(Material material) {
		super(material);
		this.setUnlocalizedName("zaisu_green");
		this.setRegistryName("BlockZaisu_green");
