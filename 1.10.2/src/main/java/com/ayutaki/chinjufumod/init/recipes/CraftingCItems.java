...
public class CraftingCItems {
	...
	public static void register() {
		/*定形レシピ*/
		/*提督ノ決裁印*/
		GameRegistry.addRecipe(new ItemStack(ChinjufuModItems.ADMIRAL_STAMP, 1), new Object [] {
			"#x#",
			"xxx",
			"yyy",
		...
		/*墨*/
		GameRegistry.addRecipe(new ItemStack(ChinjufuModItems.SUMI, 9), new Object [] {
				"x",
		...
		/*耐久値を消費するレシピ*/
		/*指示書の発行*/
		GameRegistry.addRecipe(new ItemStack(ChinjufuModItems.WORK_ORDER, 8), new Object [] {
				"xxx",
				"xyx",
				"xxx",
				'x', new ItemStack(Items.PAPER),
				'y', new ItemStack(ChinjufuModItems.ADMIRAL_STAMP, 1, OreDictionary.WILDCARD_VALUE)
		});
