...
public class BlockUnitDesk_s extends Block {
	...
	public BlockUnitDesk_s(Material material) {
		super(material);
		this.setUnlocalizedName("unitdesk_s");
		this.setRegistryName("BlockUnitDesk_s");
