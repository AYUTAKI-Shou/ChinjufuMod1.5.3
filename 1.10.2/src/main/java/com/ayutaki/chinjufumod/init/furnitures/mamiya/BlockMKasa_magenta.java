...
public class BlockMKasa_magenta extends Block {
	...
	public BlockMKasa_magenta(Material material) {
		super(material);
		this.setUnlocalizedName("mkasa_magenta");
		this.setRegistryName("BlockMKasa_magenta");
