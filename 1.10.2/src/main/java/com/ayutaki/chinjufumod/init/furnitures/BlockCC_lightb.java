...
public class BlockCC_lightb extends Block {

	private static final AxisAlignedBB BOUNDING_BOX = new AxisAlignedBB(0.1875, 0.0, 0.1875, 0.8125, 0.625, 0.8125);

	public BlockCC_lightb(Material material) {
		super(Material.WOOD);
		this.setUnlocalizedName("cafechair_lightb");
		this.setRegistryName("BlockCC_lightb");
