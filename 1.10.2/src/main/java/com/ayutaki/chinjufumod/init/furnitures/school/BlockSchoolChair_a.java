...
public class BlockSchoolChair_a extends Block {
	...
	public BlockSchoolChair_a(Material material) {
		super(material);
		this.setUnlocalizedName("schoolchair_a");
		this.setRegistryName("BlockSchoolChair_a");
