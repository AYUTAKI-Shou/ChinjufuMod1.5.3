...
public class BlockZaisu_purple extends Block {
	...
	public BlockZaisu_purple(Material material) {
		super(material);
		this.setUnlocalizedName("zaisu_purple");
		this.setRegistryName("BlockZaisu_purple");
