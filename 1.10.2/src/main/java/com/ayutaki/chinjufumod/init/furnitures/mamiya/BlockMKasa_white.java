...
public class BlockMKasa_white extends Block {
	...
	public BlockMKasa_white(Material material) {
		super(material);
		this.setUnlocalizedName("mkasa_white");
		this.setRegistryName("BlockMKasa_white");
