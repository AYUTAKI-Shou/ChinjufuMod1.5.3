...
public class BlockMKasa_yellow extends Block {
	...
	public BlockMKasa_yellow(Material material) {
		super(material);
		this.setUnlocalizedName("mkasa_yellow");
		this.setRegistryName("BlockMKasa_yellow");
