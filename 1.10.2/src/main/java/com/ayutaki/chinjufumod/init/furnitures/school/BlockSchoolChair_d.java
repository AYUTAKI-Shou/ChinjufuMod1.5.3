...
public class BlockSchoolChair_d extends Block {
	...
	public BlockSchoolChair_d(Material material) {
		super(material);
		this.setUnlocalizedName("schoolchair_d");
		this.setRegistryName("BlockSchoolChair_d");
