...
public class BlockMZ_black extends Block {

	private static final AxisAlignedBB BOUNDING_BOX = new AxisAlignedBB(0.0625, 0.0, 0.0625, 0.9375, 0.0625, 0.9375);

	public BlockMZ_black(Material material) {
		super(Material.CLOTH);
		this.setUnlocalizedName("mzabuton_black");
		this.setRegistryName("BlockMZ_black");
