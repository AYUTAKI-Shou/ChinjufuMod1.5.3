...
public class BlockMKasa_black extends Block {
	...
	public BlockMKasa_black(Material material) {
		super(material);
		this.setUnlocalizedName("mkasa_black");
		this.setRegistryName("BlockMKasa_black");
