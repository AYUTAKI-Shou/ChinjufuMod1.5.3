...
public class BlockCC_orange extends Block {

	private static final AxisAlignedBB BOUNDING_BOX = new AxisAlignedBB(0.1875, 0.0, 0.1875, 0.8125, 0.625, 0.8125);

	public BlockCC_orange(Material material) {
		super(Material.WOOD);
		this.setUnlocalizedName("cafechair_orange");
		this.setRegistryName("BlockCC_orange");
