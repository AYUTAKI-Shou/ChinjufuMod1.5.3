...
public class BlockMZ_orange extends Block {

	private static final AxisAlignedBB BOUNDING_BOX = new AxisAlignedBB(0.0625, 0.0, 0.0625, 0.9375, 0.0625, 0.9375);

	public BlockMZ_orange(Material material) {
		super(Material.CLOTH);
		this.setUnlocalizedName("mzabuton_orange");
		this.setRegistryName("BlockMZ_orange");
