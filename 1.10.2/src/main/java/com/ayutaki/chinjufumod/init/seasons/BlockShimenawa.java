...
public class BlockShimenawa extends Block {
	...
	public BlockShimenawa(Material material) {
		super(material);
		this.setUnlocalizedName("shimenawa");
		this.setRegistryName("BlockShimenawa");
    ...
    public void addInformation(ItemStack stack, EntityPlayer player, List<String> tooltip, boolean advanced) {
        ...
        tooltip.add(I18n.format("tip.tile.shimenawa.name", meta));
    }
}
