...
public class BlockMKasa_lime extends Block {
	...
	public BlockMKasa_lime(Material material) {
		super(material);
		this.setUnlocalizedName("mkasa_lime");
		this.setRegistryName("BlockMKasa_lime");
