...
public class BlockZaisu_orange extends Block {
	...
	public BlockZaisu_orange(Material material) {
		super(material);
		this.setUnlocalizedName("zaisu_orange");
		this.setRegistryName("BlockZaisu_orange");
