...
public class BlockLogChair_b extends Block {

	private static final AxisAlignedBB BOUNDING_BOX = new AxisAlignedBB(0.25, 0.0, 0.25, 0.75, 0.625, 0.75);

	public BlockLogChair_b(Material material) {
		super(Material.WOOD);
		this.setUnlocalizedName("logchair_b");
		this.setRegistryName("BlockLogChair_b");
