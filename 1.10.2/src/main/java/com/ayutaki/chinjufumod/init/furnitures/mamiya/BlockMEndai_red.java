...
public class BlockMEndai_red extends Block {
	...
	public BlockMEndai_red(Material material) {
		super(material);
		this.setUnlocalizedName("mendai_red");
		this.setRegistryName("BlockMEndai_red");
