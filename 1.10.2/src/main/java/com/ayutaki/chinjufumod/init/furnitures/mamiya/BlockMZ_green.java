...
public class BlockMZ_green extends Block {

	private static final AxisAlignedBB BOUNDING_BOX = new AxisAlignedBB(0.0625, 0.0, 0.0625, 0.9375, 0.0625, 0.9375);

	public BlockMZ_green(Material material) {
		super(Material.CLOTH);
		this.setUnlocalizedName("mzabuton_green");
		this.setRegistryName("BlockMZ_green");
