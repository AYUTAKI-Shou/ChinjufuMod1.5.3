...
public class BlockMKasa_pink extends Block {
	...
	public BlockMKasa_pink(Material material) {
		super(material);
		this.setUnlocalizedName("mkasa_pink");
		this.setRegistryName("BlockMKasa_pink");
