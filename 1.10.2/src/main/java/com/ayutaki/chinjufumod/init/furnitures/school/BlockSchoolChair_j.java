...
public class BlockSchoolChair_j extends Block {
	...
	public BlockSchoolChair_j(Material material) {
		super(material);
		this.setUnlocalizedName("schoolchair_j");
		this.setRegistryName("BlockSchoolChair_j");
