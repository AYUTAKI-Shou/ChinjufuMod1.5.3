...
public class BlockSchoolChair_b extends Block {
	...
	public BlockSchoolChair_b(Material material) {
		super(material);
		this.setUnlocalizedName("schoolchair_b");
		this.setRegistryName("BlockSchoolChair_b");
